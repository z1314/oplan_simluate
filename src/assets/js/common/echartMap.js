    ...
    for (let item of this.originalData) {
      ...
      for (let index in item) {
        ...
        switch (item.line_type_id) {
          case 4: //确定是500kv
            if (
              index.indexOf("_type") == -1 &&
              index.includes("number") == false
            ) {
              if (item.line_number == 1) {
    ...
    this.option = {
      ...
      series: [
        ...
        //拐角icon
        {
          type: "scatter",
          symbol:
            "image://http://image.orait.cn/oplanStatic/img/mainNetPlan/runAnimation/500kv变电站.svg",
          coordinateSystem: "bmap",
          zlevel: 2,
          rippleEffect: {
            show: false,
        ...
        },
        {
          type: "scatter",
          symbol:
            "image://http://image.orait.cn/oplanStatic/img/mainNetPlan/runAnimation/220kv变电站.svg",
          coordinateSystem: "bmap",
          zlevel: 2,
          rippleEffect: {
            show: false,
        ...
        },
        {
          type: "scatter",
          symbol:
            "image://http://image.orait.cn/oplanStatic/img/mainNetPlan/runAnimation/风电场.svg",
          coordinateSystem: "bmap",
          zlevel: 2,
          rippleEffect: {
            show: false,
        ...
        },
        {
          type: "scatter",
          symbol:
            "image://http://image.orait.cn/oplanStatic/img/mainNetPlan/runAnimation/火电站.svg",
          coordinateSystem: "bmap",
          zlevel: 2,
          rippleEffect: {
            show: false,
